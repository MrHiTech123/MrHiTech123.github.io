...
<ul>
	...
	<li>Image 2: The CAVE system in real life, featuring a wall screen and a floor screen. When the game is running, 
	images are projected onto those screens, so that a player standing in the CAVE feels like they're truly in the level.</li>
</ul>
`,
